...
app.get('/api/get-data', (req, res) => {
    ...
    if (resultObject.accepted !== "Accepted") {
        (async () => {
          ...
          const generatedText = result[0].candidates[0].output.toString();
          console.log(generatedText);
      
          resultObject.ai_response = generatedText;
      
          // Continue with any additional code that relies on resultObject.ai_response
        })();
      }
